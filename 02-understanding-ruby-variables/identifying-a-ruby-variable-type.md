...
ใน Ruby	ยืดหยุ่นที่สุด ตรวจสอบได้ทั้งเชิงลึกและเชิงกว้าง	✅
ใน Python	ใช้ type() และ isinstance() คล้าย Ruby	✅
ใน Java	ใช้ instanceof หรือ getClass()	✅
ใน C	ต้องรู้ตั้งแต่ประกาศตัวแปร ไม่มีการเช็คแบบ Runtime	❌
